    ...
    <div class="login_item animated bounceInDown">
      ...
      <div class="login_border">
        ...
        <div class="login_main">
          <h4 class="login_title">{{ !isPRD ? 'QSMZQ' : $t('login.title') }}{{ website.title }}</h4>
          <userLogin v-if="activeName === 'user'" ref="userLogin" :isLayout="1"></userLogin>
...
.login-container {
  ...
  .login_item {
    ...
    width: 1213px;
    height: 619px;
    background-image: url('/img/bg/zq.png');
    background-size: 100% 100%;
    .login_border {
      width: 48%;
      height: 97%;
      ...
      .login_main {
        ...
        margin: 95px auto;
        .login_title {
          background-image: -webkit-linear-gradient(bottom, #5a7faa, #fff);
